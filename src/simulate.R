####################################################################################################
# Code to simulate rankings from: M. Corsi and J. Urbano, "The Treatment of Ties in Rank-Biased    #
# Overlap", International ACM SIGIR, Conference on Research and Development in Information         #
# Retrieval, 2024.                                                                                 #
#                                                                                                  #
# Original code can be found at: https://github.com/julian-urbano/sigir2024-rbo                    #
####################################################################################################
